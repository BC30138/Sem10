...
A_train <- read.table("C:/Users/anna_fox/Documents/UNIVERSE/4 курс/2 semester/Нейронные_сети/All_Labs/4Lab_svm/svmdata2.txt", stringsAsFactors = TRUE)
A_test <- read.table("C:/Users/anna_fox/Documents/UNIVERSE/4 курс/2 semester/Нейронные_сети/All_Labs/4Lab_svm/svmdata2test.txt", stringsAsFactors = TRUE)
